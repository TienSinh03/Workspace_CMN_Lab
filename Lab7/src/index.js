...
const docClient = new AWS.DynamoDB.DocumentClient(); // tạo DocumentClient instance
...
//upload
const tableName = process.env.DYNAMODB_TABLE; // DynamoDB table name
...
const CLOUD_FRONT_URL = process.env.CLOUD_FRONT_URL; // URL của CloudFront để truy cập vào file đã upload lên S3
            ...
            if(err) {
                ...
                const params = {
                    ...
                    Item: {
                        ...
                        image: `${CLOUD_FRONT_URL}${filePath}` // URL of the uploaded image
